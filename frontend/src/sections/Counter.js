        ...
        {aboutData && (
          <>
            <MotionCounterCard
              ...
              transition={{ delay: 0.15 * 0 }}
              ref={counterCardRef}
              cardIcon={
                <WbSunnyOutlinedIcon sx={{ color: 'var(--mainOrange)', fontSize: '8rem' }} />
              }
            ...
            <MotionCounterCard
              ...
              initial={{ opacity: 0, y: 100 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.15 * 1 }}
              ref={counterCardRef}
              cardIcon={
                <ManageAccountsIcon sx={{ color: 'var(--mainOrange)', fontSize: '8rem' }} />
              }
